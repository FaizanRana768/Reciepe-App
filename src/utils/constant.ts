...
export const services = [
    ...
    { name: "PPC Campaigns", path: "/Services/ppc-campaign" },
    { name: "Google Analytics", path: "/Services/google-analytics" },
    { name: "Digital Marketing", path: "/Services/digital-marketing" },
    { name: "Graphic Designing", path: "/Services/google-my-business-optimization" },
    { name: "Website Development", path: "/Services/website-development" },
    { name: "Google Search Console", path: "/Services/google-search-console" },
